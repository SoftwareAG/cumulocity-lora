...
import lora.ns.actility.api.model.basestation.BsBriefIntEthernet;
...
class BaseStationApiTest {
	...
	void test_receive_basetation_with_ethernet_type() throws JsonMappingException, JsonProcessingException {
		...
		assertThat(result.getBriefs().get(0).getInts().getInt().get(0)).isInstanceOf(BsBriefIntEthernet.class);
	}
}
