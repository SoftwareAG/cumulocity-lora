 ...
 */
@JsonPropertyOrder({ BsInts.JSON_PROPERTY_INT })
@JsonTypeName("Bs_ints")
...
public class BsInts {
  ...
  private List<BsInt> _int = new ArrayList<>();

  public BsInts() {
  }

  public BsInts _int(List<BsInt> _int) {

    this._int = _int;
    return this;
  }

  public BsInts addIntItem(BsInt _intItem) {
    if (this._int == null) {
  ...
  public List<BsInt> getInt() {
    return _int;
  }

  @JsonProperty(JSON_PROPERTY_INT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setInt(List<BsInt> _int) {
    this._int = _int;
  }
  ...
  public boolean equals(Object o) {
    ...
    BsInts bsInts = (BsInts) o;
    return Objects.equals(this._int, bsInts._int);
  }
