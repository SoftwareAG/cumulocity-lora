 ...
 * BsTag
 */
@JsonPropertyOrder({ BsTag.JSON_PROPERTY_MANAGED_NETWORK_VISIBILITY, BsTag.JSON_PROPERTY_MULTICAST_VISIBILITY,
    BsTag.JSON_PROPERTY_NAME })
...
public class BsTag {
  ...
  public BsTag managedNetworkVisibility(Boolean managedNetworkVisibility) {
  ...
  public BsTag multicastVisibility(Boolean multicastVisibility) {
  ...
  public boolean equals(Object o) {
    ...
    BsTag bsTag = (BsTag) o;
    return Objects.equals(this.managedNetworkVisibility, bsTag.managedNetworkVisibility)
            && Objects.equals(this.multicastVisibility, bsTag.multicastVisibility)
            && Objects.equals(this.name, bsTag.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(managedNetworkVisibility, multicastVisibility, name);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BsTag {\n");
