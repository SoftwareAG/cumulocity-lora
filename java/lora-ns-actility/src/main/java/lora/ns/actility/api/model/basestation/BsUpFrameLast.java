 ...
 * BsUpFrameLast
 */
@JsonPropertyOrder({ BsUpFrameLast.JSON_PROPERTY_ANT, BsUpFrameLast.JSON_PROPERTY_DATE,
    BsUpFrameLast.JSON_PROPERTY_LC })
@JsonTypeName("Bs_upFrame_last")
...
public class BsUpFrameLast {
  ...
  public BsUpFrameLast() {
  }

  public BsUpFrameLast ant(String ant) {
  ...
  public BsUpFrameLast date(Long date) {
  ...
  /**
   * Last uplink frame timestamp, epoch time in milliseconds
   * 
   * @return date
   **/
  @javax.annotation.Nullable
  ...
  public BsUpFrameLast lc(String lc) {
  ...
  /**
   * Last uplink frame logical channel (LC1 ... LC7)
   * 
   * @return lc
   **/
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    BsUpFrameLast bsUpFrameLast = (BsUpFrameLast) o;
    return Objects.equals(this.ant, bsUpFrameLast.ant) && Objects.equals(this.date, bsUpFrameLast.date)
            && Objects.equals(this.lc, bsUpFrameLast.lc);
  }
