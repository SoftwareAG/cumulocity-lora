<c8y-ui-title-set title="vm.getTitle()" subtitle="vm.getSubtitle()"></c8y-ui-title-set>
        ...
        <div class="card" ng-click="drillDown(i)">
          ...
          <div class="card-block">
            <div class="col-xs-12 text-truncate">
              ...
              {{
                i.childCount || i.childAssets.references.length + i.childDevices.references.length
              }}
            </div>
          </div>
        </div>
