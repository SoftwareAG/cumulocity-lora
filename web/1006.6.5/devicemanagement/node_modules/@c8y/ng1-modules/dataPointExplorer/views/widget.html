<div ng-controller="DataPointWidgetCtrl" class="dashboard-old-minheight" style="height: 100%" ng-init="disableLocalStorage = true">
  <c8y-realtime-button
    ng-show="false"
    channel="{{channel}}"
  ...
  <div style="position: relative;" ng-style="{height: dataPointsGraphHeight}">
    <c8y-chart
      ...
      append-datepicker-to-body="true">
    </c8y-chart>
  </div>
  <c8y-alarms-events-timelines-chart
    ...
    on-update-dates="onUpdateDates($dateFrom, $dateTo)"
    realtime="child.config.realtime"
    on-realtime-alarm="onAlarm"
    on-realtime-event="onEvent"
    chart-box="chartBox"
