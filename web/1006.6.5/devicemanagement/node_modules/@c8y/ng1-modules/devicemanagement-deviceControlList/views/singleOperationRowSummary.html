  ...
  <div class="list-item-actions">
    ...
    <span class=" dropdown settings" is-open="isopen" uib-dropdown>
      ...
      <ul class="dropdown-menu dropdown-menu-right" uib-dropdown-menu>
        <li>
          <a
            title="{{ 'Execute for whole group' | translate }}"
            href=""
            ng-click="createBulkOperation(operation)"
            ng-show="deviceBulkControlEnabled"
          >
  ...
  <div class="list-item-body">
    <div class="row">
      <div class="col-sm-8">
        ...
        >
          <small
            ><i c8y-icon="cog"></i>{{ 'Device' | translate }}: {{ operation.deviceName }}</small
          >
        </a>
      </div>
