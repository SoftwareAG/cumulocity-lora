<div ng-controller="c8yDataPointTableWidgetCtrl as ctrl">
  ...
  <div class="flex-row sticky-top bg-white" style="z-index: 11;">
    <div class="datepicker-container clearfix p-t-4 flex-grow">
    ...
    <label class="c8y-switch m-r-8"
      title="{{'Scroll lock' | translate}}"
      style="flex-shrink: 0; padding-bottom: 3px;">
      <input type="checkbox"
        ng-init="ctrl.scrollLocked=true"
        ng-model="ctrl.scrollLocked"
      >
        <span></span> <small>{{'Scroll lock' | translate}}</small>
    </label>
  </div>
