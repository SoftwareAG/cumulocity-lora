<div class="card" ng-if="vm.smss.length > 0 || vm.isAdmin">
  ...
  <div class="list-group">
    <div
      ...
      ng-class="{'expanded': vm.isDetailExpanded}"
      ng-repeat="sms in vm.smss"
      ng-click="vm.isDetailExpanded = !vm.isDetailExpanded"
    >
      ...
      <div class="list-item-body">
        <div class="row">
          ...
          <div class="col-sm-4">
            ...
            <br class="visible-sm" />
            <span>{{ sms.dateSent | date: 'd MMM y h:mm' }} {{sms.dateSent | date:'a' | uppercase}}</span>
          </div>
          <div class="col-sm-4">
            <label class="small" translate>Date received</label>
            <br class="visible-sm" />
            <span>{{ sms.dateReceived | date: 'd MMM y h:mm' }} {{sms.dateReceived | date:'a' | uppercase}}</span>
          </div>
