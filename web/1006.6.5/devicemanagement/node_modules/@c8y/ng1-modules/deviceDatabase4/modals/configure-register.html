          ...
          >
            <label for="messageTypeId">
              ...
              <i
                ...
                c8y-icon="question-circle"
                uib-tooltip="{{
                  'This will be matched with message ID found in source specified on device type main page'
                    | translate
                }}"
                tooltip-placement="auto"
              >
          ...
          >
            <label for="oid">
              ...
              <i
                class="text-primary"
                c8y-icon="question-circle"
                uib-tooltip="{{ 'An object identifier value, typically an address identifying a device and its status.' | translate }}"
                tooltip-placement="auto"
              ></i>
            </label>
            <input
