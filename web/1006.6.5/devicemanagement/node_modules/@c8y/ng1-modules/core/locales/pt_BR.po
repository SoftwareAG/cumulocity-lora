...
msgstr ""
"Os papéis <b>Ler</b>, <b>Criar</b>e <b>Atualizar</b> permitem LER, CRIAR E ATUALIZAR ações, respectivamente.\n"
"            O papel <b>Admin</b> permite realizar as ações de CRIAR, ATUALIZAR e EXCLUIR."
...
msgstr "<strong>Nenhuma validação para esse recurso.</strong> Adicione uma regra de validação clicando abaixo."
...
msgstr "Adicionar operação de shell do dispositivo"
...
msgstr "Depois de concluir o processo você não poderá mais acessar seu tenant com <b>{{vm.domainName}}</b>, em vez disso use seu novo nome de domínio. Se encontrar algum problema ao acessar seu tenant, contate o serviço de suporte."
...
msgstr "Depois de concluir o processo você não pode acessar mais seu tenant com o nome de domínio personalizado, em vez disso, use seu nome de domínio antigo. Se encontrar algum problema para acessar seu tenant contate o suporte."
...
msgstr "Depois que a ativação for concluída, não poderá mais acessar seu tenant com {{vm.domainName}}, em vez disso, use seu novo nome de domínio personalizado {{vm.newDomainName}}."
...
msgstr ""
"Tem certeza que deseja editar o papel global?\n"
"      Insira \"{{ctrl.randomString}}\" para confirmar:"
...
msgstr ""
"Alterar\n"
"            <a href=\"#/applicationsettings\">configurações do aplicativo</a>."
...
msgstr "As alterações no name server precisam de tempo para se propagar e entrar em vigor. Aguarde aproximadamente uma hora antes de ativar seu domínio aqui."
...
msgstr ""
"Mudar o papel global \"devices\" pode provocar uma falha de segurança. Por exemplo, se um dispositivo for comprometido, os invasores podem\n"
"      ter acesso estendido à plataforma."
...
msgstr ""
"Configure suas \n"
"            <a href=\"#/eventprocessing\">próprias regras e ações de processamento</a>."
...
msgstr "Informações do dashboard"

msgid "Dashboard layout"
msgstr "Layout do dashboard"
...
msgstr "Margem padrão do widget"
...
msgstr "Clique duas vezes para adicionar pontos e definir a área. Clique e arraste os pontos para ajustar."
...
msgstr "E-mail que será enviado após os dados serem excluídos. Espaços reservados: {tenant}, {size} - uso de armazenamento em%"
...
msgstr "E-mail que será enviado um dia antes de os dados serem excluídos. Espaços reservados: {tenant}, {size} - uso de armazenamento em%"
...
msgstr "Filtrar intervalo de datas"
...
msgstr "Obtenha mais informações sobre os aplicativos disponíveis no <a c8y-guide-href=\"reference/applications/#application-names\">Reference guide</a>."
...
msgstr "Obtenha mais informações no <a c8y-guide-href=\"users-guide/cockpit/#rules\">User guide</a>."
...
msgstr "Obtenha mais informações no <a c8y-guide-href=\"users-guide/device-management/#adding-instructions-to-the-simulator\" target=\"_blank\" rel=\"noopener noreferrer\">User guide</a>."
...
msgstr "Para obter detalhes, consulte a <a c8y-guide-href=\"users-guide/administration/\">User guide</a>."
...
msgstr ""
"Para o espaço reservado ser reconhecido, é preciso usá-lo pelo menos uma vez\n"
"        em chaves de fechamento sem outra expressão, p.ex. <var ng-non-bindable>{{placeholderName}}</var>.\n"
"        Então você pode usar esse placeholderName em ligações tratadas pelo Angular.\n"
"        Também estão disponíveis funções predefinidas:"
...
msgstr "Se nenhuma restrição for definida, os tipos de dispositivo serão aplicados em qualquer local adequado no servidor OPC UA."
...
msgstr "Localização na navegação"
...
msgstr "Nenhum modelo de rastreador especificado para este dispositivo! Escolha um da lista de modelos suportados abaixo."
...
msgstr "Não é um OPC UA URI válido."
...
msgstr "Exibindo apenas {{count}} dispositivos por motivos de desempenho"
...
msgstr "Ordem no menu de navegação (10.000 primeiro, -10.000 por último)"
...
msgstr "Espaço reservado: {tenant} - ID de tenant suspenso"
...
msgstr "Por favor, forneça o e-mail nas configurações do usuário para usar a funcionalidade de exportação."

msgid "Please retry or <a href=\"mailto:support@cumulocity.com\">reach us</a> if you're not able to upgrade."
msgstr "Tente novamente ou <a href=\"mailto:support@cumulocity.com\">entre em contato conosco</a> se não conseguir atualizar."
...
msgstr "Alterne para a guia de controle para ver o status atual da operação."
...
msgstr "Colocar novo snapshot  para o dispositivo"

msgid "Putting new snapshot to device"
msgstr "Adicionando um novo snapshot ao dispositivo"
...
msgstr "Redefinir dados de registro"
...
msgstr "Selecionar todas as Leituras"
...
msgstr "O arquivo selecionado é muito grande &ndash; o limite do tamanho é {{limitBytes | bytes}}."
...
msgstr ""
"A especificação de restrições de aplicação automática permite limitar o escopo em que os tipos de dispositivos\n"
"      são aplicados, por exemplo, especificando um conjunto de possíveis servidores ou IDs de nós."
...
"            applications."
msgstr ""
"Subscreva os aplicativos e\n"
"            <a href=\"#/applications\">configure</a>seus próprios\n"
"            aplicativos."
...
msgstr "Para ativar seu domínio, você precisa de uma licença válida. Entre em contato com nosso suporte para instalar uma licença para seu domínio."
...
"              certificate."
msgstr ""
"Excesso de certificados personalizados. Com uma ID de certificado vazia, você somente pode ter um\n"
...
msgstr ""
"Ative o(s) dispositivo(s) registrado(s) e aguarde até que as conexões sejam estabelecidas.\n"
"      Uma vez que um dispositivo esteja conectado, seu status mudará para \"Aceitação pendente\".\n"
"      Você deve aprová-lo clicando no botão \"aceitar\"."
...
msgstr "Modelo de rastreador não suportado \"{{tracker.device.c8y_Hardware.model}}\"! Selecione um dos modelos suportados na lista abaixo."
...
msgstr "O valor deve ser maior ou igual a 1"
...
msgstr "Iremos usar a informação fornecida no próximo<br> ciclo de cobrança, começando em {{vm.resolve.contractInfo.NextBillingDate | absoluteDateTimeFormat:'ll'}}."
...
msgstr "Bem-vindo ao aplicativo Cockpit"
...
msgstr ""
"Você está prestes a criar versões de marca de aplicativos padrão.\n"
"       Esse processo demora até 2 minutos."
...
msgstr "aceita o objeto de status dos alarmes e retorna uma classe CSS que pode ser usada para aplicação de estilo: none, warning, minor, major, critical, por exemplo."

msgid "takes device's id and redirects user to device details view, e.g."
msgstr "toma a ID do dispositivo e redireciona o usuário para a exibição de detalhes do grupo, p.ex."

msgid "takes group's id and redirects user to group details view, e.g."
msgstr "toma a ID do grupo e redireciona o usuário para a exibição de detalhes do grupo, p.ex."
...
msgstr "você adicionou uma entrada CNAME ao seu servidor DNS. Tenha o cuidado de remover todas as entradas A do domínio curinga. Se o seu serviço DNS não fornecer entradas CNAME para certificados curinga, entre em contato com o nosso serviço de suporte"
