...
import { Pagination, ActionControl, BulkActionControl } from '../data-grid/data-grid.model';
export declare class DeviceGridService {
    ...
    getDevices(columns: DeviceGridColumn[], pagination: Pagination): Promise<import("@c8y/client").IResultList<IManagedObject>>;
    getDevicesCount(columns: DeviceGridColumn[], pagination: Pagination): Promise<number>;
    getDevicesTotal(): Promise<number>;
