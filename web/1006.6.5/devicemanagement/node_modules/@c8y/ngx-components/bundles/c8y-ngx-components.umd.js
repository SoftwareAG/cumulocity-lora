(function (global, factory) {
    ...
    */
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            newClient = new client.Client(strategy, this.client.baseUrl);
    ...
    var UserEditComponent = /** @class */ (function () {
        function UserEditComponent(state, translate, passwordService, modalConfirmService, bsModalService, alert, userService, tenantOptionService) {
            this.state = state;
            this.translate = translate;
        ...
        UserEditComponent.prototype.canUserSetupTotp = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.tenantOptionService.detail(this.TOTP_OPTION)];
                        case 1:
                            _a = _b.sent(), data = _a.data, res = _a.res;
                            return [2 /*return*/, data.value === this.TOTP_VALUE];
                    }
                });
            });
        };
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            _a = this;
                            return [4 /*yield*/, this.loginService.getEnforcePasswordStrength()];
                        case 1:
                            _a.enforcePasswordStrength = _b.sent();
                            return [2 /*return*/];
                    }
                });
            });
