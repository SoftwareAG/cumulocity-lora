    ...
    ***************************************************************************** */
    ...
    var ContextDashboardService = /** @class */ (function () {
        ...
        ContextDashboardService.prototype.getDashboard$ = function (dashboardIdOrName, dashboardType, mo) {
            ...
            var cacheRefresh = this.cacheDashboards(dashboards).pipe(operators.filter(function (dashboard) {
        ...
        ContextDashboardService.prototype.getTabs$ = function (mo, dashboardType) {
            ...
            return this.cacheDashboards(this.getContextDashboards(mo, dashboardType)).pipe(operators.map(function (_a) {
        ...
        ContextDashboardService.prototype.cacheDashboards = function (requests) {
            var _this = this;
            return rxjs.from(requests).pipe(operators.mergeAll(), operators.mergeMap(function (response) { return response.data; }), operators.tap(function (dashboard) { return _this.cache.set(dashboard.id, dashboard); }));
        };
    ...
    var WidgetConfigComponent = /** @class */ (function () {
        ...
        WidgetConfigComponent.prototype.composeWidgetConfig = function (selectedComponent, context) {
            ...
            var setting = __assign({ settings: __assign({}, selectedComponent.data.settings, lodashEs.get(selectedComponent.data.settings, 'ng1.options'), lodashEs.get(selectedComponent.data, 'ng1.options'), { context: context }) }, selectedComponent.data.config, { dashboardMo: this.mo.c8y_Dashboard });
