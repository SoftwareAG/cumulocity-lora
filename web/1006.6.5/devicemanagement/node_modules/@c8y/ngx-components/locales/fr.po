...
msgstr "(taille du fichier jusqu’à {{maxFileSizeKB}} Ko)"
...
msgstr ""
"Les rôles <b>Lire</b> , <b>Créer</b> et <b>Mettre à jour</b> permettent respectivement les actions LIRE, CRÉER et METTRE À JOUR.\n"
"            Le rôle <b>d’administration</b> permet les actions CRÉER, METTRE À JOUR et SUPPRIMER."
...
msgid "<strong>No validation for this resource.</strong> Add a validation rule by clicking below."
msgstr "<strong>Aucune validation pour cette ressource.</strong> Ajoutez une règle de validation en cliquant ci-dessous."
...
msgid "Add device shell operation"
msgstr "Ajouter des opérations liées au terminal de l’appareil"
...
msgstr "Une fois le processus terminé, vous ne pourrez plus accéder à votre gérant avec votre nom de domaine personnalisé, utilisez à la place votre ancien nom de domaine. Si vous rencontrez des problèmes pour accéder à votre gérant, veuillez contacter le support."

msgid "After the activation is completed you will no longer be able to access your tenant with {{vm.domainName}}, instead use your new custom domain name {{vm.newDomainName}}."
msgstr "Une fois l’activation terminée, vous ne pourrez plus accéder à votre gérant avec {{vm.domainName}}. Veuillez utiliser à la place votre nouveau nom de domaine personnalisé {{vm.newDomainName}}."
...
"          permettant l’accès aux autorisations, vous pouvez resteindre davantage l’accès aux objets contenant le \n"
"          type défini."
...
msgstr ""
"Appliquer le tableau de bord à tous les appareils du type \n"
"                    <i>{{ dashboard.deviceTypeValue }}</i>"
...
msgstr ""
"Voulez-vous vraiment modifier le rôle global ?\n"
"      Veuillez entrer \"{{ctrl.randomString}}\" pour confirmer :"
...
msgstr "Il n’est pas possible de planifier à nouveau l’opération en masse. Toutes ses opérations ont déjà été effectué avec succès."
...
msgid ""
"Change\n"
"            <a href=\"#/applicationsettings\">application settings</a>."
msgstr ""
"Modifiez les \n"
"            <a href=\"#/applicationsettings\">paramètres de l’application</a>."
...
msgid "Changes in the name server need time to propagate and take effect. Wait approximately one hour before activating your domain here."
msgstr "Il faut un certain temps pour que les modifications du nom du serveur se propagent et deviennent effectives. Attendez environ une heure avant d’activer votre domaine ici."
...
msgstr ""
"La modification du rôle global \"Appareils\" peut entraîner une faille de sécurité, p.ex. si un appareil est compromis, des personnes malveillantes\n"
"      peuvent avoir un accès étendu à la plateforme."
...
msgid ""
"Configure your\n"
"            <a href=\"#/eventprocessing\">own processing rules and actions</a>."
msgstr ""
"Configurez vos\n"
"            <a href=\"#/eventprocessing\"> propres règles de traitement et actions</a>."
...
msgstr "Informations sur le tableau de bord"
...
msgstr "Le traitement du courtier en données est actuellement surchargé et peut stopper le transfert de vos données. Veuillez contacter l’assistance."
...
msgstr "Le traitement du courtier en données n’arrive pas à se connecter au gérant de destination. Le transfert de données ne fonctionne pas. Veuillez contacter l’assistance."
...
msgstr "Style de l’en-tête du widget par défaut"

msgid "Default widget margin"
msgstr "Marge du widget par défaut"
...
msgstr "Double-cliquez pour ajouter des points et définir la zone. Cliquez et faites glisser les points pour ajuster."
...
msgid "Email which will be sent after over-limit data has been deleted. Placeholders: {tenant}, {size} - storage usage in %"
msgstr "E-mail envoyé après avoir supprimé les données de dépassement de limite. Espaces réservés : {tenant}, {size} - utilisation du stockage en %"
...
msgid "Email which will be sent one day before data is deleted. Placeholders: {tenant}, {size} - storage usage in %"
msgstr "E-mail envoyé un jour avant la suppression des données. Espaces réservés : {tenant}, {size} - utilisation du stockage en %"
...
msgid "Find out more about available applications in the <a c8y-guide-href=\"reference/applications/#application-names\">Reference guide`KEEP_ORIGINAL`</a>."
msgstr "Pour en savoir plus sur les applications disponibles, consultez le guide <a c8y-guide-href=\"reference/applications/#application-names\">Reference guide</a>."
...
msgid ""
"Find out more in the\n"
"            <a c8y-guide-href=\"users-guide/cockpit/#rules\">User guide`KEEP_ORIGINAL`</a>."
msgstr ""
"Pour en savoir plus, veuillez consulter le\n"
"            <a c8y-guide-href=\"users-guide/cockpit/#rules\">User guide</a>."
...
msgid ""
"Find out more in the\n"
"          <a c8y-guide-href=\"users-guide/cockpit/#visualize\">User guide`KEEP_ORIGINAL`</a>."
msgstr ""
"Pour en savoir plus, consultez le guide\n"
"          <a c8y-guide-href=\"users-guide/cockpit/#visualize\">User guide</a>."

msgid ""
"Find out more in the\n"
"          <a c8y-guide-href=\"users-guide/overview/\">User guide`KEEP_ORIGINAL`</a>."
msgstr ""
"Pour en savoir plus, veuillez consulter le\n"
"          <a c8y-guide-href=\"users-guide/overview/\">User guide</a>."

msgid ""
"Find out more in the\n"
"        <a c8y-guide-href=\"mqtt/smartrest-2/#creating-templates-via-mqtt\">Device SDK guide`KEEP_ORIGINAL`</a>."
msgstr ""
"Pour en savoir plus, consultez\n"
"        <a c8y-guide-href=\"mqtt/smartrest-2/#creating-templates-via-mqtt\">Device SDK guide</a>."
...
msgid ""
"Find out more in the\n"
"        <a c8y-guide-href=\"users-guide/device-management/#configsnap\">User guide`KEEP_ORIGINAL`</a>."
msgstr ""
"Pour en savoir plus, veuillez consulter\n"
"        <a c8y-guide-href=\"users-guide/device-management/#configsnap\">User guide </a>."
...
msgid "Find out more in the <a c8y-guide-href=\"users-guide/cockpit/#rules\">User guide`KEEP_ORIGINAL`</a>."
msgstr "Pour en savoir plus, consultez le guide <a c8y-guide-href=\"users-guide/cockpit/#rules\">User guide</a>."

msgid "Find out more in the <a c8y-guide-href=\"users-guide/device-management/#adding-instructions-to-the-simulator\" target=\"_blank\" rel=\"noopener noreferrer\">User guide`KEEP_ORIGINAL`</a>."
msgstr "Pour en savoir plus, consultez le guide <a c8y-guide-href=\"users-guide/device-management/#adding-instructions-to-the-simulator\" target=\"_blank\" rel=\"noopener noreferrer\">User guide</a>."
...
msgid "For details refer to the <a c8y-guide-href=\"users-guide/administration/\">User guide`KEEP_ORIGINAL`</a>."
msgstr "Pour plus de détails, consultez le guide <a c8y-guide-href=\"users-guide/administration/\">User guide</a>."
...
msgstr ""
"Pour reconnaître les espaces réservés, il doit être utilisé au moins une fois\n"
"        dans des accolades sans autre expression, p.ex. <var ng-non-bindable>{{placeholderName}}</var>.\n"
"        Vous pouvez ensuite utiliser le nom de cet espace réservé dans des liaisons gérées par Angular.\n"
"       Des fonctions prédéfinies sont également disponibles :"
...
msgid "If no constraints are set, device types are applied at any fitting location on the OPC UA server."
msgstr "Si aucune contrainte n’est définie, les types d’appareils sont appliqués à chaque emplacement qui convient sur le serveur OPC UA."
...
msgstr "Chargement des événements et des alarmes"
...
msgstr "Emplacement dans la navigation"
...
msgid "No tracker model specified for this device. Select one from the list of supported models below."
msgstr "Aucun modèle de traqueur indiqué pour cet appareil. Sélectionnez-en un dans la liste des modèles pris en charge ci-dessous."
...
msgid "Only showing {{count}} devices due to performance reasons"
msgstr "Affichage de {{count}} appareils uniquement pour des raisons de performance"
...
msgstr "Trier dans le menu de navigation (10 000 premiers, -10 000 derniers)"
...
msgstr "Espace réservé : {tenant} - ID du gérant suspendu"
...
msgstr "Veuillez ajouter des widgets à ce tableau de bord."
...
msgstr "Veuillez noter que les appareils avec des intervalles de communication plus longs passent en veille en raison de leur inactivité. Pour les appareils en veille, aucune commande ne peut être exécutée durant cette période. Afin de sortir l’appareil du mode veille , vous aurez besoin de mettre l’appareil sur un chargeur."

msgid "Please provide email in user settings in order to use export functionality."
msgstr "Veuillez indiquer une adresse e-mail dans les paramètres utilisateur pour utiliser les fonctionnalités d’exportation."

msgid "Please retry or <a href=\"mailto:support@cumulocity.com\">reach us</a> if you're not able to upgrade."
msgstr "Veuillez réessayer ou <a href=\"mailto:support@cumulocity.com\">contactez-nous</a> si vous n’arrivez pas à mettre à niveau votre version."

msgid "Please select at least one severity."
msgstr "Veuillez sélectionner au moins une gravité."

msgid "Please switch to the control tab to see the current status of the operation."
msgstr "Veuillez aller sur l’onglet de contrôle pour voir l’état actuel de l’opération."

msgid "Please type something to execute a search."
msgstr "Veuillez entrer du texte pour exécuter une recherche."
...
msgstr "Ajouter nouvelle configuration à l’appareil"

msgid "Putting new snapshot to device"
msgstr "Ajout de la nouvelle configuration à l’appareil en cours"
...
msgstr "Le traitement de l’événement en temps réel est actuellement surchargé et peut interrompre le traitement de vos événements. Veuillez contacter l’assistance."
...
msgstr "Opération en masse programmée pour terminer l’opération sur les appareils ayant échoué au préalable."
...
msgstr "Le fichier sélectionné est trop volumineux, la limite de taille est {{limitBytes | bytes}}."
...
msgid ""
"Specifying auto-apply constraints allows you to limit the scope where the device\n"
"      types are applied, for example by specifying a set of possible servers or node IDs."
msgstr ""
"La définition de contraintes d’auto-application vous permet de limiter l’étendue là où les types\n"
"      d’appareils sont appliqués, par exemple en indiquant un ensemble de serveurs ou d’ID de nœuds possibles."
...
msgid ""
"Subscribe to applications and\n"
"            <a href=\"#/applications\">set up</a> your own\n"
"            applications."
msgstr ""
"S’abonner aux applications et\n"
"            <a href=\"#/applications\">configurer</a> vos propres\n"
"            applications."
...
"                <i>{{ dashboard.deviceTypeValue }}</i>."
msgstr ""
"Ce tableau de bord est accessible à tous les appareils du type\n"
"                <i>{{ dashboard.deviceTypeValue }}</i>."
...
msgid "To activate your domain, you need a valid license. Please contact our support to install a license for your domain."
msgstr "Pour activer votre domaine, vous avez besoin d’une licence valide. Veuillez contacter votre support client pour installer une licence pour votre domaine."
...
msgid ""
"Too many custom certificates. With an empty Certificate ID field, you can have only one custom\n"
"              certificate."
msgstr ""
"Trop de certificats personnalisés. Lorsque le champ d’ID du certificat est vide, vous ne disposez \n"
"              que d’un seul certificat personnalisé."
...
msgstr ""
"Allumez l(es) appareil(s) enregistré(s) et patientez jusqu’à l’établissement de la/des connexion(s).\n"
"      Une fois qu’un appareil est connecté, son état passe à \"En attente d’acceptation\".\n"
"      Vous devrez l’approuver en cliquant sur \"Accepter\"."
...
msgid "Unsupported tracker model \"{{tracker.device.c8y_Hardware.model}}\". Select one of the supported models from the list below."
msgstr "Modèle de traqueur non pris en charge \"{{tracker.device.c8y_Hardware.model}}\". Sélectionnez l’un des modèles pris en charge dans la liste ci-dessous."
...
msgstr "Un maximum de 6 archives peut être enregistré dans la plate-forme. Si vous chargez une nouvelle archive, les archives plus anciennes qui ne sont pas actives seront supprimées. Voulez-vous poursuivre ?"
...
msgstr "Mettre à jour le crédit maximum"
...
msgstr "Utiliser le compteur de réinitialisation"
...
msgid "Value must be greater than or equal to 1"
msgstr "La valeur doit être supérieure ou égale à 1"
...
msgstr "Réglages du distributeur automatique"
...
msgstr "Nous utiliserons les informations fournies lors du prochain<br> cycle de facturation, à compter du {{vm.resolve.contractInfo.NextBillingDate | absoluteDateTimeFormat:'ll'}}."
...
msgstr "Bienvenue dans l’application de Cockpit"
...
msgstr "Vous allez appliquer la configuration de personnalisation, la rendant visible pour tous les sous-gérants. Voulez-vous continuer ?"
...
msgstr "Vous allez supprimer l’enregistrement de l’appareil pour l’ID \"{{id}}\". Voulez-vous continuer ?"

msgid "You are about to close your account. Do you want to proceed?"
msgstr "Vous allez clôturer votre compte. Voulez-vous continuer ?"
...
msgstr "Vous allez créer un nouveau groupe \"{{name}}\" et lui affecter l’appareil. Voulez-vous continuer ?"
...
msgstr "Vous allez créer une règle qui va supprimer définitivement les données correspondantes au bout de {{maximumAge}} jours (exécuté la nuit). Voulez-vous continuer ?"

msgid ""
"You are about to create branded versions of standard applications.\n"
"       This process takes up to 2 minutes."
msgstr ""
"Vous êtes sur le point de créer des versions personnalisées d’applications standard.\n"
...
msgstr ""
"Vous êtes sur le point de supprimer les identifiants du fournisseur SMS. La suppression des identifiants va bloquer tout utilisateur utilisant \n"
"      une authentification à deux facteurs basée sur les SMS et va aussi désactiver les Smart Rules basées sur les SMS tout comme la communication entre les appareils. \n"
"      Voulez-vous poursuivre ?"

msgid "You are about to delete SmartREST template \"{{name}}\". Do you want to proceed?"
msgstr "Vous allez supprimer le modèle SmartREST \"{{name}}\". Voulez-vous continuer ?"

msgid "You are about to delete alarm mapping for alarm type \"{{alarmType}}\". Do you want to proceed?"
msgstr "Vous allez supprimer le mappage d’alarme pour le type d’alarme \"{{alarmType}}\". Voulez-vous poursuivre ?"

msgid "You are about to delete application \"{{app | humanizeAppName}}\". Do you want to proceed?"
msgstr "Vous allez supprimer l’application \"{{app | humanizeAppName}}\". Voulez-vous continuer ?"

msgid "You are about to delete archive \"{{name}}{{description ? (' (' + description + ')') : ''}}\". Do you want to proceed?"
msgstr "Vous allez supprimer l’archive \"{{name}}{{description ? (' (' + description + ')') : ''}}\". Voulez-vous continuer ?"

msgid "You are about to delete configuration \"{{name}}\". Do you want to proceed?"
msgstr "Vous allez supprimer la configuration \"{{name}}\". Voulez-vous continuer ?"

msgid "You are about to delete connector \"{{name}}\". Do you want to proceed?"
msgstr "Vous allez supprimer le connecteur \"{{name}}\". Voulez-vous continuer ?"

msgid "You are about to delete data point \"{{kpiLabel}}\". Do you want to proceed?"
msgstr "Vous allez supprimer le point de données \"{{kpiLabel}}\". Voulez-vous continuer ?"
...
msgstr "Vous allez supprimer l’appareil \"{{name}}\". Cette opération est irréversible. Voulez-vous poursuivre ?"

msgid "You are about to delete device protocol {{protocolType}} \"{{protocolName}}\". Do you want to proceed?"
msgstr "Vous allez supprimer le protocole de l’appareil {{protocolType}} \"{{protocolName}}\". Voulez-vous continuer ?"
...
msgstr "Vous allez supprimer le type d’appareil \"{{name}}\". Les appareils connectés de ce type seront indisponibles. Voulez-vous continuer ?"

msgid "You are about to delete endpoint \"{{config.name}}\" from device \"{{device.name}}\". Do you want to proceed?"
msgstr "Vous allez supprimer le point de terminaison \"{{config.name}}\" de l’appareil \"{{device.name}}\". Voulez-vous continuer ?"

msgid "You are about to delete file \"{{name}}\". Do you want to proceed?"
msgstr "Vous êtes sur le point de supprimer le fichier \"{{name}}\". Voulez-vous continuer ?"

msgid "You are about to delete firmware item \"{{name}}\". Do you want to proceed?"
msgstr "Vous allez supprimer l’élément du microprogramme \"{{name}}\". Voulez-vous continuer ?"
...
msgstr "Vous êtes sur le point de supprimer le groupe \"{{name}}\" et ses sous-groupes de manière récursive. Cette opération est irréversible. Voulez-vous continuer ?"

msgid "You are about to delete group \"{{name}}\". Do you want to proceed?"
msgstr "Vous allez supprimer le groupe \"{{name}}\". Voulez-vous poursuivre ?"

msgid "You are about to delete group \"{{name}}\". This operation is irreversible. Do you want to proceed?"
msgstr "Vous allez supprimer le groupe \"{{name}}\". Cette opération est irréversible. Voulez-vous continuer ?"

msgid "You are about to delete report \"{{name}}\". Do you want to proceed?"
msgstr "Vous allez supprimer le rapport \"{{name}}\". Voulez-vous continuer ?"

msgid "You are about to delete role \"{{name}}\". Do you want to proceed?"
msgstr "Vous allez supprimer le rôle \"{{name}}\". Voulez-vous continuer ?"

msgid "You are about to delete simulator \"{{name}}\". Do you want to proceed?"
msgstr "Vous allez supprimer le simulateur \"{{name}}\". Voulez-vous continuer ?"

msgid "You are about to delete smart rule \"{{name}}\". Do you want to proceed?"
msgstr "Vous êtes sur le point d’effacer la Smart Rule \"{{name}}\". Voulez-vous poursuivre ?"

msgid "You are about to delete software item \"{{name}}\". Do you want to proceed?"
msgstr "Vous allez supprimer l’élément de logiciel \"{{name}}\". Voulez-vous continuer ?"

msgid "You are about to delete subscription \"{{connectorName}}\". Do you want to proceed?"
msgstr "Vous allez supprimer l’abonnement \"{{connectorName}}\". Voulez-vous continuer ?"

msgid "You are about to delete tenant \"{{company}}\" (ID \"{{id}}\"). Do you want to proceed?"
msgstr "Vous allez supprimer le gérant \"{{company}}\" (ID \"{{id}}\"). Voulez-vous continuer ?"

msgid "You are about to delete the configuration \"{{name}}\". Do you want to proceed?"
msgstr "Vous êtes sur le point de supprimer la configuration \"{{name}}\". Voulez-vous continuer ?"

msgid "You are about to delete the current configuration. Do you want to proceed?"
msgstr "Vous allez supprimer la configuration actuelle. Voulez-vous continuer ?"

msgid "You are about to delete the dashboard \"{{name}}\" from all devices of the type \"{{deviceTypeValue}}\". Do you want to proceed?"
msgstr "Vous allez supprimer le tableau de bord \"{{name}}\" de tous les appareils du type \"{{deviceTypeValue}}\". Voulez-vous poursuivre ?"

msgid "You are about to delete the dashboard \"{{name}}\". Do you want to proceed?"
msgstr "Vous allez supprimer le tableau de bord \"{{name}}\". Voulez-vous continuer ?"

msgid "You are about to delete the external ID \"{{externalId}}\" of the type \"{{type}}\". Do you want to proceed?"
msgstr "Vous allez supprimer l’ID externe \"{{externalId}}\" du type \"{{type}}\". Voulez-vous continuer ?"

msgid "You are about to delete the global role \"{{name}}\". Do you want to proceed?"
msgstr "Vous allez supprimer le rôle global \"{{name}}\". Voulez-vous continuer ?"

msgid "You are about to delete the module \"{{name}}\". Do you want to proceed?"
msgstr "Vous allez supprimer le module \"{{name}}\". Voulez-vous continuer ?"

msgid "You are about to delete the resource with the ID \"{{id}}\". Do you want to proceed?"
msgstr "Vous allez supprimer la ressource avec l’ID \"{{id}}\". Voulez-vous continuer ?"

msgid "You are about to delete this log file. Do you want to proceed?"
msgstr "Vous allez supprimer ce fichier journal. Voulez-vous continuer ?"

msgid "You are about to delete this retention rule. Do you want to proceed?"
msgstr "Vous allez supprimer cette règle de conservation de données. Voulez-vous poursuivre ?"

msgid "You are about to delete user \"{{userName}}\". Do you want to proceed?"
msgstr "Vous allez supprimer l’utilisateur \"{{userName}}\". Voulez-vous continuer ?"
...
msgstr "Vous allez supprimer vos identifiants IMPACT. La suppression des identifiants entraîne la rupture de la connexion vers l’instance IMPACT. Voulez-vous continuer ?"

msgid "You are about to leave this page and discard the changes made. Do you want to proceed?"
msgstr "Vous allez quitter cette page et rejeter les modifications effectuées. Voulez-vous continuer ?"

msgid "You are about to load registration data saved on {{temporaryRegistration.timestamp}}. Do you want to proceed?"
msgstr "Vous allez charger les données d’enregistrement enregistrées le {{temporaryRegistration.timestamp}}. Voulez-vous continuer ?"

msgid "You are about to overwrite the resource with the ID \"{{id}}\". Do you want to proceed?"
msgstr "Vous allez écraser la ressource avec l’ID \"{{id}}\". Voulez-vous continuer ?"
...
msgstr "Vous allez recharger l’application afin d’appliquer correctement les modifications de réglage des unités de mesures. Voulez-vous continuer ?"

msgid "You are about to reload the application in order to see changes. Do you want to proceed?"
msgstr "Vous allez recharger l’application afin de voir les modifications. Voulez-vous continuer ?"
...
"        La personnalisation par défaut sera affichée pour tous les sous-gérants. Voulez-vous poursuivre ?"
...
msgstr "Vous allez lancer le traitement des modifications du logiciel. Veuillez noter que cette opération est asynchrone. Voulez-vous continuer ?"
...
msgstr "Vous allez suspendre le gérant \"{{company}}\" (ID \"{{id}}\"). Voulez-vous poursuivre ?"

msgid "You are about to unassign device \"{{name}}\". Do you want to proceed?"
msgstr "Vous allez désaffecter l’appareil \"{{name}}\". Voulez-vous continuer ?"
...
msgstr "Vous pouvez ajouter des horaires une fois que vous avez enregistré la configuration de l’exportation."
...
msgstr "p.ex. Martin Michel&amp;Fils"
...
msgid "takes alarms status object and returns a CSS class that can be used for styling: none`KEEP_ORIGINAL`, warning`KEEP_ORIGINAL`, minor`KEEP_ORIGINAL`, major`KEEP_ORIGINAL`, critical`KEEP_ORIGINAL`, e.g."
msgstr "prend l’objet d’état des alarmes et renvoie une classe CSS qui peut être utilisée pour le style : p.ex none, warning, minor, major, critical, p.ex."

msgid "takes device's id and redirects user to device details view, e.g."
msgstr "prend l’identifiant de l’appareil et redirige l’utilisateur vers la vue des détails de l’appareil, p.ex."

msgid "takes group's id and redirects user to group details view, e.g."
msgstr "prend l’identifiant du groupe et redirige l’utilisateur vers la vue des détails du groupe, p.ex."
...
msgid "you added a CNAME entry to your DNS server. Make sure to remove all A entries for the wildcard domain. If your DNS service does not provide CNAME entries for wildcard certificates, please contact our support"
msgstr "vous avez ajouté une entrée CNAME à votre serveur DNS. Veuillez-vous assurer de supprimer toutes les entrées A du domaine de caractères génériques. Si votre service DNS ne fournit pas d’entrées CNAME pour les certificats de caractères génériques, veuillez contacter notre assistance"
