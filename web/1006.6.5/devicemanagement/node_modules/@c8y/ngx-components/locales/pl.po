...
msgstr[0] "(podrzędne: {{ $count }})"
msgstr[1] "(podrzędne: {{ $count }})"
msgstr[2] "(podrzędne: {{ $count }})"
...
msgstr ""
"Role <b>Odczyt</b>, <b>Tworzenie</b> i <b>Aktualizacja</b> pozwalają na wykonywanie odpowiednio czynności ODCZYT, TWORZENIE i AKTUALIZACJA.\n"
"            Rola <b>Administrowanie</b> pozwala na wykonywanie czynności TWORZENIE, AKTUALIZACJA i USUWANIE."
...
msgstr "<strong>Brak walidacji tego zasobu.</strong> Dodaj regułę walidacji, klikając poniżej."
...
msgstr "Dodaj operację powłoki urządzenia"
...
msgstr "Po zakończeniu tego procesu przestaniesz mieć dostęp do swojego tenanta przy użyciu nazwy domeny <b>{{vm.domainName}}</b>. Zamiast niej będzie trzeba używać nowej nazwy domeny. Jeśli wystąpią jakiekolwiek problemy z uzyskaniem dostępu do tenanta, skontaktuj się z pomocą techniczną."
...
msgstr "Po zakończeniu tego procesu przestaniesz mieć dostęp do swojego tenanta przy użyciu niestandardowej nazwy domeny. Zamiast niej będzie trzeba używać starej nazwy domeny. Jeśli wystąpią jakiekolwiek problemy z uzyskaniem dostępu do tenanta, skontaktuj się z pomocą techniczną."
...
msgstr "Po zakończeniu aktywacji przestaniesz mieć dostęp do swojego tenanta przy użyciu nazwy domeny {{vm.domainName}}. Zamiast niej będzie trzeba używać nowej niestandardowej nazwy domeny {{vm.newDomainName}}."
...
msgstr ""
"Czy na pewno chcesz zmodyfikować rolę globalną?\n"
"      Wprowadź kod „{{ctrl.randomString}}”, aby potwierdzić:"
...
msgstr ""
"Zmień\n"
"            <a href=\"#/applicationsettings\">ustawienia aplikacji</a>."
...
msgstr "Zmiany na serwerze nazw wymagają czasu, zanim zostaną rozpowszechnione i zaczną obowiązywać. Zaczekaj około godziny, zanim aktywujesz w tym miejscu swoją domenę."
...
msgstr ""
"Zmiana roli globalnej „urządzenia” może doprowadzić do zagrożenia bezpieczeństwa. Jeśli na przykład w urządzeniu powstała luka w zabezpieczeniach, atakujący mogą \n"
"      uzyskać rozszerzony dostęp do platformy."
...
msgstr "Kliknij tutaj, aby edytować"
...
msgstr "Powitanie w aplikacji Kokpit"
...
msgstr ""
"Skonfiguruj\n"
"            <a href=\"#/eventprocessing\">własne działania i reguły przetwarzania</a>."
...
msgstr "Domyślny margines widżetu"
...
msgstr "Kliknij dwukrotnie, aby dodać punkty i ustawić obszar. Kliknij i przeciągnij punkty, aby je dostosować."
...
msgstr "Wiadomość e-mail, która zostanie wysłana po usunięciu danych przekraczających limit. Symbole zastępcze: {tenant}, {size} - wykorzystanie pamięci masowej w %"
...
msgstr "Wiadomość e-mail, która zostanie wysłana jeden dzień przed usunięciem danych. Symbole zastępcze: {tenant}, {size} - wykorzystanie pamięci masowej w %"
...
msgid "Execute (via"
msgstr "Wykonaj (za pośrednictwem"
...
msgstr "Dowiedz się więcej o dostępnych aplikacjach z podręcznika <a c8y-guide-href=\"reference/applications/#application-names\">Reference guide</a>."
...
msgstr "Dowiedz się więcej z podręcznika <a c8y-guide-href=\"users-guide/cockpit/#rules\">User guide</a>."
...
msgstr "Dowiedz się więcej z podręcznika <a c8y-guide-href=\"users-guide/device-management/#adding-instructions-to-the-simulator\" target=\"_blank\" rel=\"noopener noreferrer\">User guide</a>."
...
msgstr "Szczegółowe informacje zawiera podręcznik <a c8y-guide-href=\"users-guide/administration/\">User guide</a>."
...
msgstr ""
"Aby symbol zastępczy został rozpoznany, musi zostać użyty co najmniej raz\n"
"         w nawiasach klamrowych bez żadnego innego wyrażenia, np. <var ng-non-bindable>{{placeholderName}}</var>.\n"
"        Następnie można używać tego symbolu zastępczego w powiązaniach obsługiwanych przez bibliotekę Angular.\n"
"        Dostępne są także wstępnie zdefiniowane funkcje:"
...
msgstr "W przypadku braku ograniczeń typy urządzeń są stosowane w dowolnej pasującej lokalizacji na serwerze OPC UA."
...
msgstr "Lokalizacja w nawigacji"
...
msgstr "Nie określono modelu urządzenia śledzącego dla tego urządzenia. Wybierz jeden z listy obsługiwanych modeli poniżej."
...
msgstr "Ze względu na wydajność liczba wyświetlanych urządzeń wynosi tylko {{count}}"
...
msgstr "Kolejność w menu nawigacji (10000 pierwsze, -10000 ostatnie)"
...
msgstr "Symbol zastępczy: {tenant} - identyfikator zawieszonego tenanta"
...
msgstr "Dodaj widżety do pulpitu."
...
msgstr "Aby korzystać z funkcji eksportu, podaj adres e-mail w ustawieniach użytkownika."

msgid "Please retry or <a href=\"mailto:support@cumulocity.com\">reach us</a> if you're not able to upgrade."
msgstr "Spróbuj ponownie lub <a href=\"mailto:support@cumulocity.com\">skontaktuj się z nami</a>, jeśli nie jesteś w stanie przejść na wersję płatną."
...
msgstr "Umieść nową migawkę na urządzeniu"

msgid "Putting new snapshot to device"
msgstr "Umieszczanie nowej migawki na urządzeniu"
...
msgstr ""
"Określenie ograniczeń automatycznego zastosowania umożliwia ograniczenie zakresu, \n"
"      w którym stosowane są typy urządzeń, na przykład można określić zestaw możliwych serwerów lub identyfikatorów węzłów."
...
"            applications."
msgstr ""
"Subskrybuj aplikacje\n"
"            i <a href=\"#/applications\">konfiguruj</a> własne\n"
"            aplikacje."
...
msgstr "Aby aktywować domenę, trzeba mieć ważną licencję. Skontaktuj się z naszą pomocą techniczną, aby zainstalować licencję dla Twojej domeny."
...
"              certificate."
msgstr ""
"Zbyt wiele certyfikatów niestandardowych. Jeśli pole identyfikatora certyfikatu jest puste,\n"
"              może istnieć tylko jeden certyfikat niestandardowy."
...
msgstr ""
"Włącz zarejestrowane urządzenie(-a) i zaczekaj na nawiązanie połączenia(-eń).\n"
"      Po podłączeniu urządzenia jego status zostanie zmieniony na „Oczekiwanie na akceptację”.\n"
"      Należy je zatwierdzić, klikając przycisk „Akceptuj”."
...
msgstr "Nieobsługiwany model urządzenia śledzącego „{{tracker.device.c8y_Hardware.model}}”. Wybierz jeden z obsługiwanych modeli z poniższej listy."
...
msgstr "Wartość musi być większa lub równa 1"
...
msgstr "Z podanych informacji skorzystamy w następnym<br> cyklu rozliczeniowym, który zaczyna się {{vm.resolve.contractInfo.NextBillingDate | absoluteDateTimeFormat:'ll'}}."
...
msgstr ""
"Zamierzasz utworzyć oznakowane marką wersje standardowych aplikacji.\n"
"       Ten proces potrwa około 2 minut."
...
msgstr ""
"Zamierzasz usunąć poświadczenia dostawcy SMS. Usunięcie poświadczeń spowoduje zablokowanie\n"
"      wszystkich użytkowników z  uwierzytelnianiem dwuetapowym opartym na SMS oraz dezaktywowanie reguł\n"
"      inteligentnych i komunikacji z urządzeniami opartych na SMS. \n"
...
msgstr "pobiera obiekt stanu alarmów i zwraca klasę CSS, którą można wykorzystać do nadania stylów: none, warning, minor, major, critical, np."
...
msgstr "dodano wpis CNAME do serwera DNS. Należy usunąć wszystkie wpisy A dotyczące domeny wieloznacznej. Jeśli usługa DNS nie udostępnia wpisów CNAME dla certyfikatów wieloznacznych, skontaktuj się z naszą pomocą techniczną"
...
msgstr "{{instruction.seconds}} sek"
