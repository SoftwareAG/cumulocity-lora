...
msgstr ""
"<b>읽기</b>, <b>생성</b> 및 <b>업데이트</b> 역할은 각각 읽기, 생성 및 업데이트 작업을 허용합니다.\n"
"            <b>관리자</b> 역할은 생성, 업데이트 및 삭제 작업을 허용합니다."
...
msgstr "<strong>이 리소스에 대한 유효성 검사가 없습니다.</strong> 아래를 클릭하여 유효성 검사 규칙을 추가하십시오."
...
msgstr "프로세스 완료 후에는 <b>{{vm.domainName}}</b> 사용을 통해 테넌트에 액세스할 수 없으며, 대신 새 도메인 이름을 사용해야 합니다. 테넌트 액세스에 문제가 있는 경우 지원 팀에 문의하십시오."
...
msgstr "프로세스 완료 후에는 사용자 지정 도메인 이름 사용을 통해 테넌트에 액세스할 수 없으며, 대신 이전 도메인 이름을 사용해야 합니다. 테넌트 액세스에 문제가 있는 경우 지원 팀에 문의하십시오."
...
msgstr "활성화 완료 후에는 {{vm.domainName}} 사용을 통해 테넌트에 액세스할 수 없으며, 대신 새 사용자 지정 도메인 이름({{vm.newDomainName}})을 사용해야 합니다."
...
msgstr ""
"전역 역할을 편집하시겠습니까?\n"
"      \"{{ctrl.randomString}}\" 입력을 통해 확인하십시오:"
...
msgstr ""
"<a href=\"#/applicationsettings\">애플리케이션 설정</a>\n"
"            을 변경하십시오."
...
msgstr "서버 이름 변경 시 전파하여 적용되기까지 시간이 필요합니다. 여기에서 도메인을 활성화하는데 약 1시간이 소요됩니다."
...
msgstr ""
"전역 역할권한 \"디바이스\" 변경 시 보안 취약점이 발생할 수 있습니다. 예: 디바이스 보안이 침입자에 의해 공격당한경우\n"
"      플랫폼에 대한 액세스를 연장했을 수 있습니다."
...
msgstr ""
"<a href=\"#/eventprocessing\">자체 처리 규칙 및 조치</a>\n"
"            를 구성하십시오."
...
msgstr "두 번 클릭하여 위치를 추가하고 영역을 설정합니다. 위치를 클릭하고 끌어서 조정합니다."
...
msgstr "데이터 한도 초과 후 전송된 이메일이 삭제되었습니다. 자리 표시자: {tenant}, {size} - 스토리지 사용량(%)"
...
msgstr "데이터 하루 전에 전송된 이메일이 삭제됩니다. 자리 표시자: {tenant}, {size} - 스토리지 사용량(%)"
...
msgstr "<a c8y-guide-href=\"reference/applications/#application-names\">Reference guide</a>에서 사용 가능한 애플리케이션에 대해 자세히 알아보십시오."
...
msgstr ""
"자세한 내용은\n"
"          <a c8y-guide-href=\"users-guide/cockpit/#visualize\">User guide</a>에서 알아보십시오."
...
msgstr ""
"자세한 내용은\n"
"        <a c8y-guide-href=\"users-guide/overview/\">User guide</a>에서 알아보십시오."
...
msgstr "<a c8y-guide-href=\"users-guide/cockpit/#rules\">User guide</a>에서 자세히 알아보십시오."
...
msgstr "<a c8y-guide-href=\"users-guide/device-management/#adding-instructions-to-the-simulator\" target=\"_blank\" rel=\"noopener noreferrer\">User guide</a>에서 자세히 알아보십시오."
...
msgstr "<a c8y-guide-href=\"users-guide/administration/\">User guide</a>에서 자세한 내용을 알아보십시오."
...
msgstr ""
"자리 표시자가 인식되려면 다른 표현식 없이\n"
"        최소 한 번 이상 중괄호를 통해 사용되어야 합니다. 예: <var ng-non-bindable>{{placeholderName}}</var>.\n"
"        그런 다음 Angular에서 처리하는 바인딩에 placeholderName을 사용할 수 있습니다.\n"
"        또한 다음 사전 정의된 함수를 사용할 수 있습니다:"
...
msgstr "설정된 제약이 없는 경우 OPC UA 서버에서 적합한 위치에 디바이스 유형이 적용됩니다."
...
msgstr "이 디바이스에 대해 지정된 추적기 모델이 없습니다. 아래 지원되는 모델 목록에서 하나를 선택하십시오."
...
msgstr "성능 문제로 {{count}}개의 디바이스만 표시"
...
msgstr "내비게이션 메뉴에서 명령(처음 10000, 마지막 -10000)"
...
msgstr "플레이스 홀더: {tenant} - 유예된 테넌트의 ID"
...
msgstr "내보내기 기능을 사용하려면 사용자 설정에 이메일을 입력하십시오."

msgid "Please retry or <a href=\"mailto:support@cumulocity.com\">reach us</a> if you're not able to upgrade."
msgstr "업그레이드할 수 없는 경우 다시 시도하거나 <a href=\"mailto:support@cumulocity.com\">문의</a>하십시오."
...
msgstr "제어 탭으로 전환하여 작업의 현재 상태를 확인합니다."

msgid "Please type something to execute a search."
msgstr "입력하여 검색을 실행하십시오."
...
msgstr "디바이스에 신규 스냅샷 배치"

msgid "Putting new snapshot to device"
msgstr "디바이스에 새 스냅샷 배치 중"
...
msgstr "선택한 파일이 너무 큽니다. &ndash; 크기 제한은 {{limitBytes | bytes}}입니다."
...
msgstr ""
"자동 적용 제약을 지정하면 디바이스 유형이 적용되는\n"
"      범위를 제한할 수 있습니다(예: 가능한 서버 세트 또는 노드 ID 지정)."
...
msgstr ""
"애플리케이션을 구독하고 자체 \n"
"            애플리케이션을 <a href=\"#/applications\">설정</a>\n"
"            하십시오."
...
"                <i>{{ dashboard.deviceTypeValue }}</i>."
msgstr ""
"이 대시보드는 <i>{{ dashboard.deviceTypeValue }}</i>\n"
"        유형의 모든 디바이스 에서 공유됩니다."
...
msgstr "도메인을 활성화하려면 유효한 라이선스가 필요합니다. 지원 팀에 문의하여 도메인에 대한 라이선스를 설치하십시오."
...
"              certificate."
msgstr ""
"사용자 지정 인증서가 너무 많습니다. 인증 ID가 비어 있는 경우 단 하나의 사용자 지정\n"
"              인증서만 보유할 수 있습니다."
...
msgstr ""
"등록된 디바이스를 켜고 연결이 설정될 때까지 대기하십시오.\n"
"      디바이스가 연결되면 상태가 \"승인 보류 중\"으로 변경됩니다.\n"
"      \"승인\" 버튼을 클릭하여 이를 승인해야 합니다."
...
msgstr "지원되지 않는 추적기 모델 \"{{tracker.device.c8y_Hardware.model}}\". 아래 목록에서 지원되는 모델 중 하나를 선택하십시오."
...
msgstr "다음 결제 주기부터 제공된 정보를 사용하며,<br> 결제 주기는 {{vm.resolve.contractInfo.NextBillingDate | absoluteDateTimeFormat:'ll'}}에 시작됩니다."
...
msgstr "Cockpit 애플리케이션에 오신걸 환영합니다"
...
msgstr ""
"기본 애플리케이션의 브랜디드 버전을 생성하려 합니다.\n"
"       이 프로세스는 최대 2분까지 소요됩니다."
...
msgstr ""
"OpenIT 자격 증명을 삭제하려 합니다. 자격 증명을 삭제하면 SMS 기반 2단계 인증을 \n"
"      사용하는 모든 사용자를 잠그고 SMS 기반 Smart rule 및 디바이스 통신을 비활성화합니다. \n"
"      계속 진행하시겠습니까?"
...
msgstr "{{temporaryRegistration.timestamp}}에 저장된 등록 데이터를 불러오려 합니다. 계속 진행하시겠습니까?"
...
msgstr "경보 상태 개체를 가져와서 스타일링에 사용할 수 있는 CSS 클래스를 반환함: 없음, 경고, 중요하지 않음, 중요, 긴급, 예: none, warning, minor, major, critical, 예"
...
msgstr "DNS 서버에 CNAME 항목을 추가했습니다. 와일드카드 도메인에 대한 모든 A 항목을 제거해야 합니다. DNS 서비스에서 와일드카드 인증서에 대한 CNAME 항목을 제공하지 않은 경우 지원 팀에 문의하십시오"
