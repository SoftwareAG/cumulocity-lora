...
import { assign, pick, some, keys, keyBy, has, clone, cloneDeep, sortBy, omit, get, escapeRegExp, findIndex, values } from 'lodash-es';
...
var WidgetConfigComponent = /** @class */ (function () {
    ...
    WidgetConfigComponent.prototype.composeWidgetConfig = function (selectedComponent, context) {
        ...
        var setting = __assign({ settings: __assign({}, selectedComponent.data.settings, get(selectedComponent.data.settings, 'ng1.options'), get(selectedComponent.data, 'ng1.options'), { context: context }) }, selectedComponent.data.config, { dashboardMo: this.mo.c8y_Dashboard });
