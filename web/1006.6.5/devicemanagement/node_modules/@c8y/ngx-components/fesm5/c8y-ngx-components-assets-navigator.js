import { __extends, __awaiter, __generator, __values, __decorate, __assign, __spread, __param } from 'tslib';
import { InjectionToken, Injectable, Optional, Inject, NgModule } from '@angular/core';
import { gettext, NavigatorNode, DeviceStatusComponent, ModalService, AlertService, BreadcrumbService, AppStateService, ModalModule, DeviceStatusModule, HOOK_NAVIGATOR_NODES } from '@c8y/ngx-components';
import { PagingStrategy, InventoryService, UserService } from '@c8y/client';
import { ApiService } from '@c8y/ngx-components/api';
import { Subject, empty } from 'rxjs';
import { scan, map, filter, mergeMap } from 'rxjs/operators';
import { get, flatMap, map as map$1, includes, reject } from 'lodash-es';
...
var AssetNodeService = /** @class */ (function () {
    ...
    AssetNodeService.prototype.getRootNodes = function () {
        ...
        if (this.user.hasRole(this.appState.currentUser.value, 'ROLE_INVENTORY_READ')) {
            ...
            return this.inventory
                ...
                .pipe(scan(function (acc, val) { return __spread(acc, val); }, []), map(function (groups) { return _this.rejectSubgroups(groups); }))
                .toPromise();
        }
    };
    ...
    AssetNodeService.prototype.rejectSubgroups = function (groups) {
        var allChildAssetRefs = flatMap(groups, 'childAssets.references');
        var allChildAssetIds = map$1(allChildAssetRefs, 'managedObject.id');
        var isSubgroup = function (group) { return includes(allChildAssetIds, group.id); };
...
export { AssetNode, AssetNodeFactory, AssetNodeService, AssetsNavigatorModule, DeviceGroupService, GroupFragment, ASSET_NAVIGATOR_CONFIG as ɵa };
