import { IIdentified, Service, IResult, IObservableOptions } from '../core';
...
export declare class UserService extends Service<IUser> {
     ...
     */
    list$(filter?: object, options?: IObservableOptions): import("rxjs").Observable<IUser[]>;
    /**
     * Removes user.
     *
    ...
    hasRole(user: IUser, roleId: string): any;
