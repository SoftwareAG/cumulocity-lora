...
import { IObservableOptions } from './ObservableList';
import { Observable } from 'rxjs';
export declare class Service<TData extends IIdentified> {
    ...
    protected list$(filter?: any, options?: IObservableOptions): Observable<TData[]>;
    protected detail(entityOrId: string | number | IIdentified): Promise<IResult<TData>>;
    protected detail$(entityOrId: string | number | IIdentified, options?: IObservableOptions): Observable<TData>;
    protected create(entity: Partial<TData>): Promise<IResult<TData>>;
    protected update(entity: Partial<TData>): Promise<IResult<TData>>;
    protected delete(entityOrId: string | number | IIdentified): Promise<IResult<null>>;
    ...
    protected getRealtime(entityOrId: string | number | IIdentified): any;
