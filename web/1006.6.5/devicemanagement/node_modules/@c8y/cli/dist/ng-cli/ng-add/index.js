...
function addDependencies(tree) {
    const dependencies = [
        ...
        { name: '@angular/http', version: '~7.2.15', type: dependencies_1.NodeDependencyType.Default },
        { name: '@angular/cdk', version: '~8.2.3', type: dependencies_1.NodeDependencyType.Default },
