import { DataGridComponent, DataSourceModifier, DeviceGridColumn, FilteringActionType, ServerSideDataResult, _ } from '@c8y/ngx-components';
...
export class LoraDevicesComponent {
    ...
    async loadDevices(columns: DeviceGridColumn[], pagination: Pagination) {
