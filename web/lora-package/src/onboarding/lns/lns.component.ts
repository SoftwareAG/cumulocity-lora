...
export class LNSComponent {
    ...
    constructor(private router: Router, private inventory: InventoryService, private identity: IdentityService, private fetchClient: FetchClient, private modalService: BsModalService) {
    ...
    delete(lnsConnector: IManagedObject) {
        ...
        this.deleteLNSModalRef = this.modalService.show(this.deleteLNSModal, { backdrop: true, ignoreBackdropClick: true });
    }
