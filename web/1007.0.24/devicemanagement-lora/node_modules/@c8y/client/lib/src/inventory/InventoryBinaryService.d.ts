...
import { Service, IResult, IFetchResponse, IObservableOptions } from '../core';
...
export declare class InventoryBinaryService extends Service<IManagedObjectBinary> {
     ...
     * ```
     */
    list$(filter?: object, options?: IObservableOptions): import("rxjs").Observable<IManagedObjectBinary[]>;
