import { IIdentified, Service, IResult, IResultList, IFetchClient, IObservableOptions, QueriesUtil } from '../core';
...
export declare class InventoryService extends Service<IManagedObject> {
     ...
     */
    detail$(entityOrId: IdReference, options?: IObservableOptions): Observable<IManagedObject>;
    /**
     ...
     * rxjs `defer()` or `from()` to composite an observable on your own.
     */
    list$(filter?: object, options?: IObservableOptions): Observable<IManagedObject[]>;
    /**
