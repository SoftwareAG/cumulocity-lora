...
msgstr "下で 1 つ以上の OPC UA サーバーを構成できます。OPC UA エージェントは、サーバーが有効化されており、接続状態が  \"接続済み\" である場合、これらのサーバーに接続します。"
...
msgstr "\"{{ failureReason }}\" のため、ファームウェアの変更を適用できませんでした。"

msgid "Could not apply firmware changes."
msgstr "ファームウェアの変更を適用できませんでした。"
...
msgstr "ロール {{ vm.enforcedUsersGroup }} のユーザーに二要素認証を強制する"
...
msgstr "ファームウェアが追加されました。オプションでデバイス タイプ フィルターを設定できます。"

msgid "Firmware changes applied."
msgstr "ファームウェアの変更が適用されました。"

msgid "Firmware changes will be applied."
msgstr "ファームウェアの変更が適用されます。"
...
msgstr "デバイス タイプが設定されていません。デバイス データベースを使用して Actility LoRa デバイス タイプを作成してください。"
...
msgstr "適合する項目は見つかりませんでした。新規エントリを追加しますか？"

msgid "No match found, add new`software`?"
msgstr "適合する項目は見つかりませんでした。新規に追加しますか？"
...
msgstr "可能な値: \"true\"、\"false`\"、ユーザーがアクティブである必要がある最終日。空欄にすると、値 \"true\" が設定されます。"
...
msgstr "ソフトウェアおよびファームウェア"

msgid "Software added, optionally set device type filter."
msgstr "ソフトウェアが追加されました。オプションでデバイス タイプ フィルターを設定できます。"
...
msgstr "検索するには、デバイスの ID または名前を入力してください。"
...
msgstr ""
"個人情報は収集されません。\n"
"            お使いの電話から取得されるデータは、センサー データと匿名化されたアプリ使用データのみです。"
...
msgstr ""
"入力された情報は、\n"
"{{ vm.resolve.contractInfo.NextBillingDate | absoluteDateTimeFormat: 'll' }} <br>\n"
...
msgstr "グローバル ロールを編集しようとしています。確認のために \"{{ ctrl.randomString }}\" を入力してください:"
...
msgstr "(例) 自分のタイプ、ワイルドカード文字としてアスタリスク (*) を使用できます"
