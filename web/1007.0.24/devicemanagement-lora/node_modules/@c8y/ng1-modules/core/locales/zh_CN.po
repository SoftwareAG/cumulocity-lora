...
msgstr "下面您可以配置一个或多个 OPC UA 服务器。如果这些服务器已启用并将连接状态设为\"已连接\"，则 OPC UA 代理将会连接到它们。"
...
msgstr ""
"在\n"
"<a c8y-guide-href=\"users-guide/cockpit/#a-name-add-data-points-a-adding-data-points\">User guide</a>中详细了解。"
...
msgstr ""
"在\n"
"<a c8y-guide-href=\"users-guide/device-management/#simulator\" target=\"_blank\" rel=\"noopener noreferrer\">User guide</a>中详细了解。"
...
msgstr ""
"在\n"
"<a c8y-guide-href=\"device-sdk/mqtt/#smartrest-2\">Device SDK guide</a>中详细了解。"
...
msgstr "未配置设备类型。使用设备数据库创建 Actility LoRa 设备类型。"
...
msgstr "可能值：\"true\"、\"false\"、用户应保持活动状态的截止日期。将其留空会将值设置为 \"true\"。"
...
msgstr ""
"我们不收集任何个人数据。\n"
"            我们从您的手机中检索的唯一数据是传感器数据和匿名的应用使用情况数据。"
...
msgstr "例如 MyType，您可以使用星号 (*) 作为通配符"
