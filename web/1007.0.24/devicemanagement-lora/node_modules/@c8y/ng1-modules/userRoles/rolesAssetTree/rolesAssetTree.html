<div class="roles-asset-tree-list">
  ...
  >
    <div ng-style="::{'padding-left': 5 + asset._depth * 15}" class="role-asset-tree-item_group">
      ...
      <span class="text-truncate" title="{{vm.title(asset)}}" ng-style="{cursor: asset._subGroups === undefined ? 'pointer' : 'default'}" style="position:relative;overflow:visible" ng-click="!asset._subGroups && vm.loadChildren(asset)">
        <i c8y-icon="question-circle" class="text-info" style="position: absolute;bottom:-0.3em;left:-0.5em;z-index: 1;" ng-hide="asset._subGroups"></i>
