import { __decorate, __assign, __awaiter, __generator, __param, __read, __extends } from 'tslib';
import { Location } from '@angular/common';
import { ComponentFactoryResolver, ViewChild, ViewContainerRef, Component, InjectionToken, Inject, Injectable, ChangeDetectorRef, EventEmitter, Input, Output, ViewChildren, TemplateRef, Directive, ContentChildren, HostBinding, forwardRef, NgModule } from '@angular/core';
import { OperationBulkService, OperationService, InventoryService, OperationBulkGeneralStatus } from '@c8y/client';
import { gettext, AlertService, Status, ModalService, OperationBulkRealtimeService, DatePickerComponent, C8yStepper, memoize, ListItemRadioComponent, FilteringActionType, CoreModule, FormsModule, HOOK_TABS } from '@c8y/ngx-components';
import { isUndefined, has, assign, cloneDeep, flatten, get, uniqWith, isEqual, property, uniq, omit, isEmpty } from 'lodash-es';
import { BsModalService, BsModalRef as BsModalRef$1 } from 'ngx-bootstrap/modal';
import { Subject, BehaviorSubject, combineLatest, pipe, from, of } from 'rxjs';
import { BsModalRef } from 'ngx-bootstrap';
import { ActivatedRoute, Router, RouterModule } from '@angular/router';
import { tap, switchMap, withLatestFrom, map, shareReplay, takeUntil, debounceTime, distinctUntilChanged, catchError, distinctUntilKeyChanged, throttleTime } from 'rxjs/operators';
...
var BulkOperationsService = /** @class */ (function () {
    ...
    BulkOperationsService = __decorate([
        Injectable(),
        __param(5, Inject(HOOK_LIST_BULK_TYPE))
...
var BulkOperationTypeListComponent = /** @class */ (function () {
    function BulkOperationTypeListComponent(router, bulkOpsService) {
        this.router = router;
        this.bulkOpsService = bulkOpsService;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.repositoryService.getBinaryText(this.selectedConfiguration.url, { allowExternal: true })];
                    case 1:
                        _a.binary = _b.sent();
                        _b.label = 2;
    ...
    OperationsModule = __decorate([
        NgModule({
            ...
            providers: [
                ...
                { provide: HOOK_LIST_BULK_TYPE, useValue: ɵ0$1 }
            ],
            entryComponents: [
                SingleOperationItemComponent,
                BulkOperationDetailsComponent,
...
export { BulkOperationDetailsComponent, BulkOperationDetailsService, BulkOperationListItemComponent, BulkOperationTypeListComponent, BulkOperationsListComponent, BulkOperationsModalComponent, BulkOperationsRescheduleModalComponent, BulkOperationsService, BulkOperationsStepperContainerComponent, C8Y_BULK_TYPES, C8Y_BULK_TYPE_FRAGMENTS, HOOK_LIST_BULK_TYPE, OperationSchedulerComponent, OperationsModule, baseUrl, routes, ɵ0, BulkOperationType as ɵa, BulkOperationFromSingleComponent as ɵc, BaseStepperComponent as ɵd, BulkOperationStepper as ɵe, CustomStep as ɵf, OperationDetailsComponent as ɵg, SingleOperationItemComponent as ɵh, SingleOperationsListComponent as ɵi, StatusFilterComponent as ɵj, BulkOperationDetailsTabsComponent as ɵk, BulkOperationWrapperComponent as ɵl, DeviceSelectorComponent as ɵm, StepperBulkTypeSoftware as ɵn, SelectSoftwareStepComponent as ɵo, StepperFirmware as ɵp, StepperBulkTypeConfiguration as ɵq, StepperBulkTypeDeviceProfile as ɵr, OperationSummaryComponent as ɵs, VersionOrPatchComponent as ɵt, SelectFirmwareComponent as ɵu, ConfirmSoftwareSelectionStepComponent as ɵv, SelectDeviceProfileStepComponent as ɵw, ConfirmDeviceProfileSelectionStepComponent as ɵx, TabsFactory as ɵy };
