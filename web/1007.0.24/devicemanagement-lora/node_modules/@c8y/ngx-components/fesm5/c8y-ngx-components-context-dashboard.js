...
import { assign, pick, some, keys, keyBy, has, cloneDeep, get, forEach, clone, sortBy, omit, escapeRegExp, findIndex, values, kebabCase } from 'lodash-es';
...
var ContextDashboardComponent = /** @class */ (function () {
    ...
    ContextDashboardComponent.prototype.mergeWidgetClasses = function (widget) {
        ...
        return __assign((_a = { card: true, 'card-dashboard': true }, _a[kebabCase(widget.componentId || widget.name)] = true, _a), widgetClasses);
    };
