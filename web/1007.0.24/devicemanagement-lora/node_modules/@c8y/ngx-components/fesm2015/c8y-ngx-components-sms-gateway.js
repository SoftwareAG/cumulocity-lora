...
import { gettext, Status, ModalService, AlertService, NavigatorNode, CoreModule, CommonModule, FormsModule, HOOK_NAVIGATOR_NODES } from '@c8y/ngx-components';
import { UpgradeModule } from '@c8y/ngx-components/upgrade';
import { FetchClient, TenantOptionsService, ApplicationService } from '@c8y/client';
...
SmsGatewayNavigationFactory = SmsGatewayNavigationFactory_1 = __decorate([
    Injectable()
...
export { SmsGatewayComponent, SmsGatewayModule, SmsGatewayService as ɵa, SmsGatewayNavigationFactory as ɵb };
