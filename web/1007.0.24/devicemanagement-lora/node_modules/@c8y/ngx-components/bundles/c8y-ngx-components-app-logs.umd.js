(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@c8y/ngx-components'), require('ngx-bootstrap/buttons'), require('@c8y/client'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@c8y/ngx-components/app-logs', ['exports', '@angular/core', '@c8y/ngx-components', 'ngx-bootstrap/buttons', '@c8y/client', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory((global.c8y = global.c8y || {}, global.c8y['ngx-components'] = global.c8y['ngx-components'] || {}, global.c8y['ngx-components']['app-logs'] = {}), global.ng.core, global.c8y['ngx-components'], global.buttons, global.client, global.rxjs, global.rxjs.operators));
}(this, (function (exports, core, ngxComponents, buttons, client, rxjs, operators) { 'use strict';
