(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/router'), require('@c8y/ngx-components'), require('@c8y/ngx-components/device-grid'), require('lodash-es')) :
    typeof define === 'function' && define.amd ? define('@c8y/ngx-components/device-grid-example', ['exports', '@angular/core', '@angular/router', '@c8y/ngx-components', '@c8y/ngx-components/device-grid', 'lodash-es'], factory) :
    (global = global || self, factory((global.c8y = global.c8y || {}, global.c8y['ngx-components'] = global.c8y['ngx-components'] || {}, global.c8y['ngx-components']['device-grid-example'] = {}), global.ng.core, global.ng.router, global.c8y['ngx-components'], global.c8y['ngx-components']['device-grid'], global.lodashEs));
}(this, (function (exports, core, router, ngxComponents, deviceGrid, lodashEs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    exports.ɵa = DeviceGridExampleComponent;
    exports.ɵb = DeviceGridExampleGuard;
    exports.ɵc = DeviceGridExampleNavigationFactory;
