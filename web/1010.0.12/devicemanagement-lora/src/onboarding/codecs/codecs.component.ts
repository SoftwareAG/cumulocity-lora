...
import { DeviceOperationParam, ParamType } from "./DeviceOperationParam";
...
export class LoraCodecsComponent {
    ...
    deleteParam(operation: DeviceOperation, param: DeviceOperationParam) {
        operation.params.splice(operation.params.indexOf(param));
    }

    addParam(operation: DeviceOperation) {
        operation.params.push(new DeviceOperationParam());
    }

    addValue(param: DeviceOperationParam) {
        if (!param.value) {
            param.value = [];
        }
        param.value.push("");
    ...
    deleteValue(param: DeviceOperationParam, value: string) {
